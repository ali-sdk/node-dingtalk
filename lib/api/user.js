...
module.exports = class User {
  ...
  * get(id, opts) {
    try {
      return yield this.client.get('user/get', Object.assign({ userid: id }, opts));
    } catch (err) {
      return undefined;
    }
  }
  ...
  * getUserInfoByCode(code) {
    return yield this.client.get('user/getuserinfo', { code });
  }
   ...
   */
  * getByMobile(mobile) {
    return yield this.client.get('user/get_by_mobile', { mobile });
  }
};
