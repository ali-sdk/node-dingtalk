...
module.exports = class Department {
  ...
  * delete(id) {
   ...
   * @return {Object} 操作结果
   */
  * listSubDepartmentIds(id, opts) {
    assert(id, 'department id required');
    return yield this.client.get('department/list_ids', { id }, opts);
  }
   ...
   * @return {Object} 操作结果
   */
  * listParentDepartmentIds(id, opts) {
    assert(id, 'department id required');
    return yield this.client.get('department/list_parent_depts_by_dept', { id }, opts);
  }
};
