...
module.exports = class Client {
  ...
  * post(api, data, opts) {
   ...
   */
  * getAccessToken() {
    let accessToken = this.cache.get('accessToken');
    if (!accessToken) {
      ...
      this.cache.set('accessToken', accessToken, accessTokenExpireTime);
    }
   ...
   */
  * getJSApiTicket() {
    let jsapiTicket = this.cache.get('jsapiTicket');
    if (!jsapiTicket) {
      ...
      this.cache.set('jsapiTicket', jsapiTicket, jsapiTicketExpireTime);
    }
    return jsapiTicket;
  }
